...
def get_date_steps(start, end, steps=None, _format="%Y-%m-%d"):
...
print("#----"*12)
[print(i) for i in get_date_steps("2020-04-27", "2020-05-23")]
print("#----"*12)
[print(i) for i in get_date_steps("2020-04-27", "2020-05-23", ("2020-05-03","2020-05-10"))]
